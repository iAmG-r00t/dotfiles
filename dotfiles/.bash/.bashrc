...
#Set custome name for bashhistory
HISTFILE=~/.dotfiles/.bash/.torical
...
#Encrypted bash alias
if [ -f ~/.dotfiles/.bash/.bash_aliases.d/.bash_aliases ]; then
    . ~/.dotfiles/.bash/.bash_aliases.d/.bash_aliases
fi
